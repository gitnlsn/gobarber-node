...
describe('Barbershop data access', () => {
    ...
    describe('CRUD', () => {
        ...
        it('Should change service type', async () => {
            const user = usersRepository.create();
            user.name = 'john doe';
            user.email = 'johndoe@mail.com';
            user.password = 'hash of an incredibly strong password';
            ...
            const serviceType1 = serviceTypeRepository.create();
            serviceType1.title = 'haircut';
            serviceType1.description = 'A cut to your hair';
            serviceType1.logoUrl = 'a url to the logo';
            await serviceTypeRepository.save(serviceType1);

            const serviceType2 = serviceTypeRepository.create();
            serviceType2.title = 'haircut';
            serviceType2.description = 'A cut to your hair';
            serviceType2.logoUrl = 'a url to the logo';
            await serviceTypeRepository.save(serviceType2);

            const service = barbershopServiceRepository.create();
            service.type = serviceType1;
            service.provider = barbershop;
            service.description = 'Simple Haircut';
            service.logoUrl = 'custom logo to haircut';
            service.price = 5000; /* R$50,00 */
            ...
            service.type = serviceType2;
            await barbershopServiceRepository.save(service);

            expect(service.type.id).toEqual(serviceType2.id);
        });
    });
});
